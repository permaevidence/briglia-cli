...
struct AdaCLI: AsyncParsableCommand {
    ...
    static let configuration = CommandConfiguration(
        ...
        subcommands: [SubscriptionCommand.self, Chat.self, Setup.self, QuickSetup.self, SetupAPI.self, Daemon.self, Doctor.self, Upgrade.self,
                      ...
                      AffinitySelftest.self, ChatWireSelftest.self, ChatAdapterSelftest.self, ResponsesSelftest.self, SubscriptionSelftest.self,
