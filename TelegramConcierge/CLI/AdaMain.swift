...
struct AdaCLI: AsyncParsableCommand {
    ...
    static let configuration = CommandConfiguration(
        ...
        subcommands: [CacheStatsCommand.self, SubscriptionCommand.self, Chat.self, Setup.self, QuickSetup.self, SetupAPI.self, Daemon.self, Doctor.self, Upgrade.self,
                      ...
                      PruneArchiveSelftest.self, MidturnAnnotationSelftest.self, MCPSurfaceSelftest.self, StorageSelftest.self,
                      ...
                      CommandMenuSelftest.self, TelegramMenuSelftest.self, BotSwitchSelftest.self, TelegramTransportSelftest.self, ParkedOutboundSelftest.self,
