...
def main():
    ...
    try:
        ...
        if not args.candidate_only:
            from web_subagent_r2_lifecycle_migration import verify_migration
            ...
            # r8 (Web subagent R2 reply-policy line) and r7 (chronology) restore the candidate, then r5 → r4 → r3 verify as before.
